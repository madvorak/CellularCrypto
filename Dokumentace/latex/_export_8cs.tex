...
\begin{DoxyCompactList}\small\item\em Public static class that gives access to our cryptographical tools. Can be used from any assembly. \end{DoxyCompactList}\end{DoxyCompactItemize}
